...
<div class="page-breadcrumb">
    <div class="row align-items-center">
        <div class="col-md-6 col-8 align-self-center">
            <h3 class="page-title mb-0 p-0">update product</h3>
        </div>
                          ...
                          <div class="row mt-3">
                              <div class="col-md-6">
                                   <label>Product name<span class="text-danger">*</span></label>
                                    <input type="text" name="name" id="name" value="{{ $edit->name }}" placeholder="Enter name" class="form-control" value="{{ old('name') }}">
                                    <p></p>
                              </div>
                          </div>
                          <div class="row mt-3">
                            <div class="col-md-6">
                                 <label>Product price<span class="text-danger">*</span></label>
                                  <input type="text" name="price" id="price" placeholder="Enter price" class="form-control"value="{{ $edit->price }}">
                                  <p></p>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                 ...
                                 <input class="form-control" type="file" name="image" id="image" accept=".jpg, .png .webp">
                                  <p></p>
                                  <img src="{{ url('uploads/product') }}/{{ $edit->image ? $edit->image : 'no_image.png' }}"
                                    width="100px">
                            </div>
                        </div>
                          ...
                          <input type="hidden" id="product_id" name="product_id" value="{{ $edit->id }}">
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response['status'] == true) {
                localStorage.setItem('successMessage', 'product update successfully');
