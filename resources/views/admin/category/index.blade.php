    ...
    <div class="page-breadcrumb">
        <div class="row align-items-center">
            <div class="col-md-6 col-8 align-self-center">
                <h3 class="page-title mb-0 p-0"> Category List</h3>
            </div>
            <div class="col-md-6 col-4 align-self-center">
                <div class="text-end upgrade-btn">
                    <a href="{{route('category.create')}}" class="btn btn-secondary d-none d-md-inline-block text-white"><i class="mdi me-2 mdi-plus-box" style="font-size:16px;color:white;"></i>Category</a>
                </div>
            </div>
        </div>
    </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data == 'removed'){
                        ...
                        var successMessageDiv = document.getElementById('success-message');
                            successMessageDiv.innerText = 'You have successfully deleted this category!';
                            successMessageDiv.style.display = 'block';
                            setTimeout(function() {
                                successMessageDiv.style.display = 'none';
                            }, 5000); 
                            ...
                            alert('category  exist please remove all account.');
                        } 
                },
